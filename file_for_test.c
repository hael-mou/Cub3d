...
/*   Updated: 2023/10/16 12:26:28 by oezzaou          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_info	*loader(char const *file)
{
	...
	info->ceiling = 0xF2F8F7ff;
	info->north = mlx_load_png("srcs/assets/wake.png");
	info->south = mlx_load_png("srcs/assets/happy.png");
	info->west = mlx_load_png("srcs/assets/oussama.png");
	info->east = mlx_load_png("srcs/assets/hamza.png");
	return (info);
}
