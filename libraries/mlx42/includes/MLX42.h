...
/*   Updated: 2023/10/12 08:42:59 by hael-mou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef mlx_key_data_t	t_data_key;
 ...
 * @param[in] param An additional optional parameter.
 */
void mlx_key_hook(mlx_t* mlx, void (*keyfunc)(), void* param);
 ...
 */
void mlx_pixel_put(mlx_image_t* image, uint32_t x, uint32_t y, uint32_t color);
